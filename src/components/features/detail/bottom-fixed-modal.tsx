...
export default function BottomFixedModal({ isOpen, onClose }: BottomFixedModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-999 flex items-end justify-center">
      {/* 배경 */}
      <div className="fixed inset-0 h-screen w-screen bg-black/50" onClick={onClose} />

      {/* 모달 본체 */}
      <div
        className="border-green bg-pale-green relative z-1000 w-full max-w-101 border-t px-5 shadow-md"
