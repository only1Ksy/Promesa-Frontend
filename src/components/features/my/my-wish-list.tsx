      ...
      {displayData.map(({ src, isEnd }, idx) =>
        src ? (
          <div key={idx} className="bg-green relative aspect-square flex-1 overflow-hidden rounded-xs">
            ...
            {isEnd && (
              <div className="text-grey-1 text-body-02 absolute inset-0 z-5 flex h-full w-full flex-col items-center justify-center bg-[#000000]/50 text-center font-medium">
