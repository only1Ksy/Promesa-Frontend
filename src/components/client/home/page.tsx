...
export default function ClientHomePage({
  ...
  return (
    <div className="flex flex-col">
      {/* 상단 배너 */}
      <div
        className="fixed top-11.5 left-1/2 flex h-112.5 w-full max-w-[var(--frame-width)] -translate-x-1/2 flex-col items-center justify-center gap-15 bg-cover bg-no-repeat"
